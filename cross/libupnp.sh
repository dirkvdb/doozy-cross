...
checkresult cd $PACKAGE \
	&& checkresult ./configure --enable-debug --disable-dependency-tracking --host=arm-linux-gnueabi --enable-ipv6 --disable-shared --disable-samples --disable-blocking-tcp-connections --prefix=/usr \
	&& checkresult make -j4 \
